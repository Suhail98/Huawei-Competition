...
with requests.Session() as session:
    ...
    session.get('http://186.1.16.32:18531/loginInfo/login/v1.0',verify=False)
    response = session.post('http://186.1.16.32:18531/loginInfo/login/v1.0', json  = query,verify=False)
